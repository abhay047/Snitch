  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] flex flex-col lg:flex-row">
      ...
      <div className="hidden lg:flex lg:w-[55%] relative flex-col justify-between p-16 overflow-hidden">
        ...
        <div className="relative space-y-10">
          <div>
            ...
            <h2 className="text-white font-black leading-none tracking-tight">
              ...
              <span className="block text-6xl xl:text-7xl text-zinc-700">
                WHAT
              </span>
              <span className="block text-6xl xl:text-7xl">YOU</span>
              <span className="block text-6xl xl:text-7xl text-yellow-400">
                ARE.
              </span>
            </h2>
          </div>
        ...
        {/* Bottom — Categories */}
        <div className="relative">
          <p className="text-zinc-700 text-xs tracking-widest uppercase mb-4">
            Explore
          </p>
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-14 lg:py-0 lg:px-16">
        <div className="w-full max-w-md">
          ...
          {/* Heading */}
          <div className="mb-10">
            <p className="text-yellow-400 text-xs tracking-[0.3em] uppercase mb-4">
              Step 1 of 1
            </p>
            <h1 className="text-white text-4xl sm:text-5xl font-black tracking-tight leading-none mb-3">
              JOIN
              <br />
              <span className="text-zinc-600">THE</span>
              <br />
              CLUB.
            </h1>
            <p className="text-zinc-500 text-sm mt-4 leading-relaxed">
              Create your free account and unlock exclusive drops, early access
              sales, and curated style picks.
            </p>
          </div>
              ...
              <label className="flex items-start gap-4 cursor-pointer group">
                ...
                <div>
                  ...
                  <p className="text-zinc-600 text-xs mt-0.5 leading-relaxed">
                    List your clothing brand and reach over 1M+ fashion-forward
                    shoppers.
                  </p>
                </div>
              </label>
